...
//     const [showReportDocViewModal, setShowReportDocViewModal] = useState(false);
//     const [showReportDocModal, setShowReportDocModal] = useState(false);

//     // avatarss
//     const [creatorAvatar, setCreatorAvatar] = useState(null);
//     const [updatedByAvatar, setUpdatedByAvatar] = useState(null);
...
//                     const updater = usersData.find(u => u.user_name === data.updated_by);
//                     setUpdatedByAvatar(updater?.avatar || null);
//                 } catch (err) {
...
//             console.log('update-criticality response received');
...
//                                     <Line type="linear" dataKey="value" stroke={COLORS.accent} strokeWidth={2} dot={{ fill: COLORS.accent, r: clampNumber(2, 3) }} activeDot={{ r: clampNumber(4, 5) }} name={label} />
//                                 </LineChart>
//                             </ResponsiveContainer>
//                         </div>
//                     </div>
...
//                                     return <Line key={param.key} type="linear" dataKey={param.key} stroke={CHART_COLORS[index % CHART_COLORS.length]} strokeWidth={2} dot={{ r: 3 }} activeDot={{ r: 5 }} name={param.label} connectNulls={true} hide={hiddenSet.has(param.key)} />
//                                 })}
//                             </LineChart>
//                         </ResponsiveContainer>
//                     </div>
...
//                                 <Line type="linear" dataKey="value" stroke={COLORS.accent} strokeWidth={3} dot={{ fill: COLORS.accent, r: 4 }} activeDot={{ r: 6 }} name={modalData.label} />                            </LineChart>
//                         </ResponsiveContainer>
//                     </div>
//                 </div>
//             </div>
...
//                                 </div>
//                                 <div style={{ fontWeight: '600', color: '#2d1f0f', display: 'flex', alignItems: 'center', gap: '8px' }}>
//                                     <div style={{
//                                         width: '28px',
//                                         height: '28px',
//                                         borderRadius: '50%',
//                                         overflow: 'hidden',
//                                         border: `2px solid ${isAppropriate ? '#10b981' : '#dc2626'}`,
//                                         background: '#E9EDF2',
//                                         flexShrink: 0,
//                                         display: 'flex',
//                                         alignItems: 'center',
...
//                                         {updatedByAvatar ? (
//                                             <img
//                                                 src={`${config.baseApi}/${updatedByAvatar}`}
//                                                 alt={data.updated_by}
//                                                 style={{ width: '100%', height: '100%', objectFit: 'cover' }}
//                                                 onError={(e) => {
//                                                     e.target.style.display = 'none';
//                                                     e.target.parentNode.innerHTML = `<span style="font-size:10px;font-weight:700;color:#8b7355">${data.updated_by?.charAt(0)?.toUpperCase() || '?'}</span>`;
//                                                 }}
//                                             />
//                                         ) : (
//                                             <span style={{ fontSize: '10px', fontWeight: 700, color: '#8b7355' }}>
//                                                 {data.updated_by?.charAt(0)?.toUpperCase() || '?'}
//                                             </span>
//                                         )}
//                                     </div>
...
//                         }, 3000);
//                     } catch (err) {
//                         showAlertMessage('error', 'Unable to save, try again!', 'Failed to save your response. Please try again.');
//                     }
//                 }
...
//             data.level2 === '1' &&
//             data.level3 === '1' &&
//             data.appropriate_action === 'yes' &&
//             (data.results === '' && data.results === null) &&
//             (data.actions === '' && data.actions === null) &&
//             (data.asset_before === '' && data.asset_before === null) &&
//             (data.asset_after === '' && data.asset_after === null)
//         ) {
//             setShowReportDocModal(true);
//         } else {
//             setShowReportDocModal(false);
//         }
//     }, [data]);

//     const ReportDocumentationDisplay = () => {
//         if (!data.results && !data.actions && !data.asset_before && !data.asset_after) return null;

//         const getImageUrl = (filename) => {
//             if (!filename) return null;
//             const clean = filename.trim().split(/[/\\]/).pop();
//             return `${config.baseApi}/documentation/${encodeURIComponent(clean)}`;
//         };
...
//                 <div style={{
//                     marginBottom: '24px',
//                     background: 'linear-gradient(135deg, #f4fff3dc 0%, #eeffeb 100%)',
//                     borderRadius: '20px',
//                     overflow: 'hidden',
//                     boxShadow: '0 8px 32px rgba(0,0,0,0.08)',
//                     border: '1px solid rgba(11, 245, 23, 0.2)',
//                     position: 'relative'
//                 }}>
//                     <div style={{ height: '3px', background: 'linear-gradient(90deg, #64b351 0%, #2cac28 50%, #0da000 100%)' }} />
...
//                             marginBottom: '20px',
//                             paddingBottom: '16px',
//                             borderBottom: '1px solid rgba(11, 245, 11, 0.15)',
//                             flexWrap: 'wrap'
//                         }}>
//                             <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
//                                 <div style={{
//                                     background: 'linear-gradient(135deg, #79ea6f 0%, #2a9909 100%)',
//                                     width: '44px', height: '44px', borderRadius: '14px',
//                                     display: 'flex', alignItems: 'center', justifyContent: 'center',
//                                     boxShadow: '0 6px 14px rgba(45, 218, 54, 0.36)', flexShrink: 0
//                                 }}>
//                                     <FeatherIcon icon="file-text" size={22} color="white" />
//                                 </div>
//                                 <div>
//                                     <h4 style={{ margin: 0, fontWeight: '700', color: '#0f2d0f', fontSize: '18px', letterSpacing: '-0.3px' }}>
//                                         Report Documentation
//                                     </h4>
//                                     <p style={{ margin: '3px 0 0', fontSize: '13px', color: '#0f2d0f' }}>
//                                         Final analysis report and findings
//                                     </p>
//                                 </div>
//                             </div>
...
//                             <button
//                                 onClick={() => setShowReportDocViewModal(true)}
//                                 style={{
//                                     background: 'linear-gradient(135deg, #79ea6f 0%, #2a9909 100%)',
//                                     border: 'none',
//                                     borderRadius: '12px',
...
//                                     gap: '8px',
//                                     transition: 'all 0.2s ease',
//                                     boxShadow: '0 4px 12px rgba(42, 153, 9, 0.3)'
//                                 }}
//                                 onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 8px 20px rgba(42, 153, 9, 0.4)'; }}
//                                 onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 12px rgba(42, 153, 9, 0.3)'; }}
//                             >
...
//                         {/* ── Results & Actions (preview) ── */}
//                         {(data.results || data.actions) && (
//                             <div style={{
//                                 display: 'grid',
//                                 gridTemplateColumns: data.results && data.actions ? '1fr 1fr' : '1fr',
//                                 gap: '16px',
//                                 marginBottom: '20px'
//                             }}>
//                                 {data.results && (
//                                     <div style={{ background: '#fafaf7', borderRadius: '14px', padding: '16px', border: '2px solid rgba(5, 145, 0, 0.6)' }}>
//                                         <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
//                                             <FeatherIcon icon="bar-chart-2" size={16} color={COLORS.accent} />
//                                             <span style={{ fontSize: '12px', fontWeight: '700', color: '#145a14', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Results</span>
//                                         </div>
//                                         <p style={{ margin: 0, fontSize: '14px', color: '#1f3e21', lineHeight: '1.65', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
//                                             {data.results}
//                                         </p>
//                                     </div>
//                                 )}
...
//                                     <div style={{ background: '#fafaf7', borderRadius: '14px', padding: '16px', border: '2px solid rgba(5, 145, 0, 0.6)' }}>
//                                         <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
//                                             <FeatherIcon icon="tool" size={16} color={COLORS.accent} />
//                                             <span style={{ fontSize: '12px', fontWeight: '700', color: '#145a14', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Actions</span>
//                                         </div>
//                                         <p style={{ margin: 0, fontSize: '14px', color: '#1f3e21', lineHeight: '1.65', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
//                                             {data.actions}
//                                         </p>
...
//                         {/* ── Before / After Images (thumbnail preview) ── */}
//                         {(data.asset_before || data.asset_after) && (
//                             <div>
//                                 <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
//                                     <FeatherIcon icon="image" size={15} color={COLORS.accent} />
//                                     <span style={{ fontSize: '12px', fontWeight: '700', color: '#11330e', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
//                                         Asset Condition
//                                     </span>
//                                 </div>
//                                 <div style={{
//                                     display: 'grid',
//                                     gridTemplateColumns: data.asset_before && data.asset_after ? '1fr 1fr' : '1fr',
//                                     gap: '16px'
//                                 }}>
//                                     {[
//                                         { key: 'asset_before', label: 'Before', badgeColor: '#327eca', badgeBg: '#E6F1FB' },
//                                         { key: 'asset_after', label: 'After', badgeColor: '#0092ac', badgeBg: '#E1F5EE' }
//                                     ].map(({ key, label, badgeColor, badgeBg }) =>
//                                         data[key] ? (
//                                             <div key={key} style={{
//                                                 borderRadius: '14px', overflow: 'hidden',
//                                                 border: '2px solid rgba(10, 155, 5, 0.57)',
...
//                                             >
//                                                 <div style={{ padding: '10px 14px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid rgba(111, 234, 117, 0.12)', background: '#fdfaf5' }}>
//                                                     <span style={{ fontSize: '11px', fontWeight: '700', padding: '3px 10px', borderRadius: '20px', background: badgeBg, color: badgeColor, letterSpacing: '0.3px', flexShrink: 0 }}>
//                                                         {label}
//                                                     </span>
//                                                     <span style={{ fontSize: '12px', color: '#185a21', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
//                                                         {data[key].split(/[/\\]/).pop()}
//                                                     </span>
//                                                 </div>
//                                                 <div style={{ position: 'relative' }}>
//                                                     <img
//                                                         src={getImageUrl(data[key])}
//                                                         alt={`Asset ${label.toLowerCase()}`}
//                                                         style={{ width: '100%', height: '200px', objectFit: 'cover', display: 'block' }}
//                                                         onError={(e) => {
//                                                             e.target.parentNode.innerHTML = `<div style="height:200px;display:flex;align-items:center;justify-content:center;background:#f5f0e8;color:#2e7c3b;font-size:13px;font-family:sans-serif;gap:10px;flex-direction:column"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>Image unavailable</div>`;
//                                                         }}
//                                                     />
//                                                     <div style={{ position: 'absolute', bottom: '8px', right: '8px', background: 'rgba(0,0,0,0.6)', borderRadius: '8px', padding: '4px 8px', display: 'flex', alignItems: 'center', gap: '4px' }}>
//                                                         <FeatherIcon icon="maximize-2" size={12} color="white" />
//                                                         <span style={{ color: 'white', fontSize: '10px' }}>Click to enlarge</span>
//                                                     </div>
//                                                 </div>
//                                             </div>
//                                         ) : null
...
//                         <div style={{ marginTop: '20px', padding: '10px 14px', background: 'rgba(171, 247, 174, 0.34)', borderRadius: '10px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px', color: '#558b58', borderLeft: '3px solid #15ca0f' }}>
//                             <FeatherIcon icon="info" size={13} color="#05b60e" />
//                             <span>This report was submitted after Level 3 review and appropriate action confirmation.</span>
//                         </div>
//                     </div>
//                 </div>
...
//                 {/* ── Enlarged View Modal ── */}
//                 <Modal
//                     show={showReportDocViewModal}
//                     onHide={() => setShowReportDocViewModal(false)}
//                     centered
//                     size="xl"
//                     contentClassName="border-0 bg-transparent"
//                 >
//                     <div style={{ borderRadius: '20px', overflow: 'hidden', maxHeight: '90vh', display: 'flex', flexDirection: 'column' }}>
//                         <Modal.Header
//                             closeButton
//                             style={{
//                                 background: 'linear-gradient(135deg, #79ea6f 0%, #2a9909 100%)',
//                                 borderBottom: '2px solid #2cac28',
//                                 borderTopLeftRadius: '20px',
//                                 borderTopRightRadius: '20px',
//                                 flexShrink: 0
//                             }}
...
//                                 Report Documentation — Full View
//                             </Modal.Title>
//                         </Modal.Header>

//                         <Modal.Body style={{ padding: '28px', background: 'linear-gradient(135deg, #f4fff3 0%, #eeffeb 100%)', overflowY: 'auto' }}>
...
//                                 border: '1px solid rgba(10, 155, 5, 0.3)'
//                             }}>
//                                 <div>
//                                     <div style={{ fontSize: '11px', color: '#558b58', textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '4px' }}>Asset</div>
//                                     <div style={{ fontWeight: '600', color: '#0f2d0f', fontSize: '15px' }}>{assetData.asset_name || '—'}</div>
//                                 </div>
//                                 <div>
//                                     <div style={{ fontSize: '11px', color: '#558b58', textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '4px' }}>Component</div>
//                                     <div style={{ fontWeight: '600', color: '#0f2d0f', fontSize: '15px' }}>{componentData.asset_component_name || '—'}</div>
//                                 </div>
//                                 <div>
//                                     <div style={{ fontSize: '11px', color: '#558b58', textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '4px' }}>Location</div>
//                                     <div style={{ fontWeight: '600', color: '#0f2d0f', fontSize: '15px' }}>{assetData.asset_location || '—'}</div>
//                                 </div>
//                                 <div>
//                                     <div style={{ fontSize: '11px', color: '#558b58', textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '4px' }}>Analysis Date</div>
//                                     <div style={{ fontWeight: '600', color: '#0f2d0f', fontSize: '15px' }}>
//                                         {data.analysis_date ? new Date(data.analysis_date).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' }) : '—'}
//                                     </div>
//                                 </div>
//                             </div>

//                             {/* Results & Actions — full text */}
//                             {(data.results || data.actions) && (
//                                 <div style={{
//                                     display: 'grid',
//                                     gridTemplateColumns: data.results && data.actions ? '1fr 1fr' : '1fr',
...
//                                 }}>
//                                     {data.results && (
//                                         <div style={{ background: 'white', borderRadius: '16px', padding: '20px', border: '2px solid rgba(5, 145, 0, 0.5)' }}>
//                                             <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '14px' }}>
//                                                 <div style={{ background: 'linear-gradient(135deg, #79ea6f 0%, #2a9909 100%)', width: '32px', height: '32px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
//                                                     <FeatherIcon icon="bar-chart-2" size={16} color="white" />
//                                                 </div>
//                                                 <span style={{ fontSize: '14px', fontWeight: '700', color: '#145a14', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Results</span>
//                                             </div>
//                                             <p style={{ margin: 0, fontSize: '15px', color: '#1f3e21', lineHeight: '1.75', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
//                                                 {data.results}
//                                             </p>
//                                         </div>
//                                     )}
...
//                                             <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '14px' }}>
//                                                 <div style={{ background: 'linear-gradient(135deg, #79ea6f 0%, #2a9909 100%)', width: '32px', height: '32px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
//                                                     <FeatherIcon icon="tool" size={16} color="white" />
//                                                 </div>
//                                                 <span style={{ fontSize: '14px', fontWeight: '700', color: '#145a14', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Actions</span>
//                                             </div>
//                                             <p style={{ margin: 0, fontSize: '15px', color: '#1f3e21', lineHeight: '1.75', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
//                                                 {data.actions}
//                                             </p>
...
//                             {/* Before / After images — large */}
//                             {(data.asset_before || data.asset_after) && (
//                                 <div>
//                                     <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
//                                         <FeatherIcon icon="image" size={18} color="#2a9909" />
//                                         <span style={{ fontSize: '14px', fontWeight: '700', color: '#11330e', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
...
//                                         ].map(({ key, label, badgeColor, badgeBg }) =>
//                                             data[key] ? (
//                                                 <div key={key} style={{ borderRadius: '16px', overflow: 'hidden', border: '2px solid rgba(10, 155, 5, 0.5)', background: 'white', boxShadow: '0 4px 16px rgba(0,0,0,0.08)' }}>
//                                                     <div style={{ padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '10px', borderBottom: '1px solid rgba(111, 234, 117, 0.2)', background: '#fdfaf5' }}>
//                                                         <span style={{ fontSize: '12px', fontWeight: '700', padding: '4px 12px', borderRadius: '20px', background: badgeBg, color: badgeColor, letterSpacing: '0.3px' }}>
//                                                             {label}
//                                                         </span>
//                                                         <span style={{ fontSize: '13px', color: '#185a21' }}>
//                                                             {data[key].split(/[/\\]/).pop()}
//                                                         </span>
//                                                     </div>
//                                                     <img
//                                                         src={getImageUrl(data[key])}
//                                                         alt={`Asset ${label.toLowerCase()}`}
//                                                         style={{ width: '100%', height: '340px', objectFit: 'contain', display: 'block', background: '#f8f8f8' }}
//                                                         onError={(e) => {
//                                                             e.target.parentNode.innerHTML = `<div style="height:340px;display:flex;align-items:center;justify-content:center;background:#f5f0e8;color:#2e7c3b;font-size:13px;font-family:sans-serif;gap:10px;flex-direction:column"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>Image unavailable</div>`;
//                                                         }}
//                                                     />
//                                                 </div>
//                                             ) : null
...
//                             <div style={{ marginTop: '24px', padding: '12px 16px', background: 'rgba(171, 247, 174, 0.34)', borderRadius: '10px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#558b58', borderLeft: '3px solid #15ca0f' }}>
//                                 <FeatherIcon icon="info" size={14} color="#05b60e" />
//                                 <span>Submitted after Level 3 review and appropriate action confirmation.</span>
//                             </div>
//                         </Modal.Body>

//                         <Modal.Footer style={{ borderTop: '1px solid rgba(10, 155, 5, 0.2)', padding: '16px 24px', background: 'white', borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px', flexShrink: 0 }}>
//                             <button
//                                 onClick={() => setShowReportDocViewModal(false)}
//                                 style={{
//                                     background: 'linear-gradient(135deg, #79ea6f 0%, #2a9909 100%)',
...
//                             >
//                                 <FeatherIcon icon="minimize-2" size={16} />
//                                 Close
//                             </button>
//                         </Modal.Footer>
//                     </div>
...
//     const ReportDocumentationModal = () => {
//         const [reportResults, setReportResults] = useState('');
//         const [reportActions, setReportActions] = useState('');
//         const [reportBeforeFile, setReportBeforeFile] = useState(null);
//         const [reportAfterFile, setReportAfterFile] = useState(null);
//         const [reportBeforePreview, setReportBeforePreview] = useState(null);
//         const [reportAfterPreview, setReportAfterPreview] = useState(null);
...
//             reader.onloadend = () => {
//                 if (type === 'before') {
//                     setReportBeforeFile(file);
//                     setReportBeforePreview(reader.result);
//                 } else {
//                     setReportAfterFile(file);
//                     setReportAfterPreview(reader.result);
//                 }
//             };
//             reader.readAsDataURL(file);
//         };
...
//                 showAlertMessage('error', 'Required', 'Please enter the input results.');
//                 return;
//             }
//             if (!reportActions.trim()) {
//                 showAlertMessage('error', 'Required', 'Please enter the input actions.');
//                 return;
//             }
...
//                 const formData = new FormData();
//                 formData.append('asset_analysis_id', asset_analysis_id);
//                 formData.append('results', reportResults);
//                 formData.append('actions', reportActions);
//                 formData.append('updated_by', empInfo.user_name);
//                 if (reportBeforeFile) formData.append('asset_before', reportBeforeFile);
//                 if (reportAfterFile) formData.append('asset_after', reportAfterFile);

//                 await axios.post(
//                     `${config.baseApi}/assetsAnalysis/upload-documentation-report-assets`,
//                     formData,
//                     { headers: { 'Content-Type': 'multipart/form-data' } }
//                 );

//                 showAlertMessage('success', 'Report submitted', 'Documentation saved successfully.');
//                 setShowReportDocModal(false);
//                 setReportResults('');
//                 setReportActions('');
//                 setReportBeforeFile(null);
//                 setReportAfterFile(null);
//                 setReportBeforePreview(null);
//                 setReportAfterPreview(null);

//                 setTimeout(() => {
//                     let countdown = 4;
//                     showAlertMessage('info', 'Redirecting', `Redirecting to dashboard in ${countdown}s...`);
...
//                             navigate('/asset-dashboard', { state: { asset_analysis_id: asset_analysis_id } });
//                         }
//                     }, 1000);
//                 }, 1500);
...
//             } catch (err) {
//                 console.error('Unable to submit report documentation:', err);
//                 showAlertMessage('error', 'Error', 'Failed to submit. Please try again.');
//             } finally {
//                 setIsSubmittingReport(false);
//             }
//         };

//         const analysisDateFormatted = data.analysis_date
//             ? new Date(data.analysis_date).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })
//             : '—';

//         return (
//             <Modal
//                 show={showReportDocModal}
//                 onHide={() => setShowReportDocModal(false)}
//                 centered
//                 size="lg"
//                 backdrop="static"
//                 keyboard={false}
...
//                 <div style={{ borderRadius: '20px', overflow: 'hidden' }}>
//                     <Modal.Header
//                         closeButton={!isSubmittingReport}
//                         style={{
//                             background: 'linear-gradient(135deg, #ffd698 0%, #ffb347 100%)',
//                             borderBottom: `2px solid ${COLORS.primary}`,
//                             borderTopLeftRadius: '20px',
...
//                                 <div style={{ fontSize: '11px', color: COLORS.gray, textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '2px' }}>Asset / Component</div>
//                                 <div style={{ fontSize: '15px', fontWeight: '600', color: COLORS.dark }}>
//                                     {assetData.asset_name || '—'} — {componentData.asset_component_name || '—'}
//                                 </div>
//                             </div>
//                             <div>
//                                 <div style={{ fontSize: '11px', color: COLORS.gray, textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '2px' }}>Location</div>
//                                 <div style={{ fontSize: '14px', fontWeight: '500', color: COLORS.dark }}>{assetData.asset_location || '—'}</div>
//                             </div>
//                             <div>
//                                 <div style={{ fontSize: '11px', color: COLORS.gray, textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '2px' }}>Analysis date</div>
//                                 <div style={{ fontSize: '14px', fontWeight: '500', color: COLORS.dark }}>{analysisDateFormatted}</div>
//                             </div>
//                         </div>
...
//                             {[
//                                 { label: 'Asset running hours', value: assetRunningHours, icon: 'clock', color: '#3b82f6' },
//                                 { label: 'Oil running hours', value: oilRunningHours, icon: 'droplet', color: COLORS.primary }
...
//                                     gap: '10px'
//                                 }}>
//                                     <FeatherIcon icon={icon} size={20} color={color} />
//                                     <div>
//                                         <div style={{ fontSize: '11px', color: COLORS.gray }}>{label}</div>
//                                         <div style={{ fontSize: '16px', fontWeight: '600', color: COLORS.dark }}>{value} hrs</div>
//                                     </div>
//                                 </div>
//                             ))}
//                         </div>

//                         <hr style={{ border: 'none', borderTop: `1px solid ${COLORS.primary}20`, margin: '0 0 20px' }} />

//                         {/* Input Results */}
//                         <div style={{ marginBottom: '16px' }}>
//                             <label style={{ fontSize: '14px', fontWeight: '600', color: COLORS.dark, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
//                                 <FeatherIcon icon="bar-chart-2" size={14} color={COLORS.accent} />
//                                 Input Results <span style={{ color: COLORS.danger }}>*</span>
//                             </label>
//                             <Form.Control
//                                 as="textarea"
//                                 rows={3}
...
//                                 placeholder="Describe the test results and findings from this analysis…"
...
//                         <div style={{ marginBottom: '20px' }}>
//                             <label style={{ fontSize: '14px', fontWeight: '600', color: COLORS.dark, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
//                                 <FeatherIcon icon="tool" size={14} color={COLORS.accent} />
//                                 Input Actions <span style={{ color: COLORS.danger }}>*</span>
//                             </label>
//                             <Form.Control
//                                 as="textarea"
//                                 rows={3}
...
//                                 placeholder="List the actions taken or recommended based on the analysis results…"
//                                 disabled={isSubmittingReport}
//                                 style={{
//                                     borderRadius: '10px',
//                                     border: `2px solid ${COLORS.primary}`,
...
//                             {[
//                                 { label: 'Asset before', type: 'before', preview: reportBeforePreview, badge: 'Before', badgeColor: '#3b82f6', badgeBg: '#e6f1fb' },
//                                 { label: 'Asset after', type: 'after', preview: reportAfterPreview, badge: 'After', badgeColor: '#10b981', badgeBg: '#e1f5ee' }
//                             ].map(({ label, type, preview, badge, badgeColor, badgeBg }) => (
//                                 <div key={type}>
//                                     <label style={{ fontSize: '13px', fontWeight: '600', color: COLORS.dark, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
//                                         <FeatherIcon icon="image" size={13} color={COLORS.accent} />
//                                         {label}
//                                         <span style={{ fontSize: '11px', fontWeight: '500', padding: '2px 8px', borderRadius: '20px', background: badgeBg, color: badgeColor, marginLeft: '4px' }}>
//                                             {badge}
//                                         </span>
//                                     </label>
//                                     <label style={{
...
//                                         justifyContent: 'center',
//                                         gap: '8px',
//                                         border: `2px dashed ${preview ? badgeColor : COLORS.primary + '60'}`,
//                                         borderRadius: '12px',
//                                         padding: '20px 12px',
//                                         cursor: isSubmittingReport ? 'not-allowed' : 'pointer',
//                                         background: preview ? badgeBg + '30' : '#fafafa',
//                                         transition: 'all 0.2s ease',
//                                         minHeight: '130px',
//                                         overflow: 'hidden'
//                                     }}>
//                                         {preview ? (
//                                             <img src={preview} alt={`${label} preview`} style={{ width: '100%', height: '120px', objectFit: 'cover', borderRadius: '8px' }} />
//                                         ) : (
//                                             <>
//                                                 <FeatherIcon icon="upload-cloud" size={28} color={COLORS.accent} />
//                                                 <span style={{ fontSize: '12px', color: COLORS.gray }}>Click to upload</span>
//                                             </>
//                                         )}
//                                         <input
//                                             type="file"
...
//                                         <button
//                                             onClick={() => {
//                                                 if (type === 'before') { setReportBeforeFile(null); setReportBeforePreview(null); }
//                                                 else { setReportAfterFile(null); setReportAfterPreview(null); }
//                                             }}
//                                             style={{ marginTop: '6px', background: 'none', border: 'none', cursor: 'pointer', fontSize: '12px', color: COLORS.danger, display: 'flex', alignItems: 'center', gap: '4px' }}
//                                         >
//                                             <FeatherIcon icon="x" size={12} /> Remove
//                                         </button>
//                                     )}
//                                 </div>
//                             ))}
...
//                     <Modal.Footer style={{ borderTop: `1px solid ${COLORS.primary}40`, padding: '16px 24px', background: 'white', borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px' }}>
//                         <button
//                             onClick={() => setShowReportDocModal(false)}
//                             disabled={isSubmittingReport}
//                             style={{ background: 'linear-gradient(45deg,#ea6f6f,#f92f2f)', border: 'none', borderRadius: '12px', padding: '12px 32px', color: 'white', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
//                         >
//                             Cancel
//                         </button>
//                         <button
//                             onClick={handleSubmit}
//                             disabled={isSubmittingReport}
//                             style={{ background: 'linear-gradient(45deg,#EAB56F,#F9982F,#E37239)', border: 'none', borderRadius: '12px', padding: '12px 32px', color: 'white', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', opacity: isSubmittingReport ? 0.7 : 1 }}
//                         >
//                             {isSubmittingReport
//                                 ? <><Spinner animation="border" size="sm" /> Submitting…</>
//                                 : <><FeatherIcon icon="file-text" size={16} /> Submit report</>
//                             }
//                         </button>
//                     </Modal.Footer>
//                 </div>
...
//                                 {empInfo.emp_position === 'l2' && data.appropriate_action === 'yes'
//                                     && !data.results && !data.actions && !data.asset_before && !data.asset_after && (
//                                         <button
//                                             onClick={() => setShowReportDocModal(true)}
//                                             style={{
...
//                                                 gap: '8px',
//                                                 transition: 'all 0.3s ease',
//                                                 boxShadow: '0 4px 15px rgba(227,114,57,0.3)'
//                                             }}
//                                         >
...
//                                                 {creatorAvatar ? (
//                                                     <img
//                                                         src={`${config.baseApi}/${creatorAvatar}`}
//                                                         alt={data.created_by}
//                                                         style={{ width: '100%', height: '100%', objectFit: 'cover' }}
//                                                         onError={(e) => {
//                                                             e.target.style.display = 'none';
//                                                             e.target.parentNode.innerHTML = `<span style="font-size:11px;font-weight:700;color:#EAB56F">${data.created_by?.charAt(0)?.toUpperCase() || '?'}</span>`;
//                                                         }}
//                                                     />
//                                                 ) : (
...
export default function ViewSubmittedAsset() {
    ...
    const asset_analysis_id = searchParams.get('id');
    // const asset_analysis_id = new URLSearchParams(window.location.search).get('id');
    const empInfo = JSON.parse(localStorage.getItem("user"));
            ...
            if (data.criticality_analysis_status) {
                ...
                if (data.criticality_analysis_status === 'Good/Ok') {
                    try {
                        ...
                        // window.location.href = '/AssetReliabilityMonitoringSystem/all-submit-asset';

                        navigate('/all-submit-asset')
                    } catch (err) {
                        console.log('Error checking for resampling schedule: ', err);
                    }
                ...
                setTimeout(() => {
                    ...
                    const interval = setInterval(() => {
                        ...
                        if (countdown > 0) {
                            ...
                            clearInterval(interval);
                            // Use window.location.href instead of navigate to avoid state issues
                            // window.location.href = '/AssetReliabilityMonitoringSystem/asset-dashboard';
                        }
                    }, 1000);
                }, 1500);
    ...
    const handleDownloadPDF = useCallback(async () => {
        ...
        try {
            ...
            const setTxtColor = (hex) => pdf.setTextColor(...hexToRgb(hex));
            ...
            const loadImageAsBase64 = (url, keepTransparency = false) => new Promise(async (resolve) => {
                try {
                    ...
                    reader.onloadend = () => {
                        ...
                        img.onload = () => {
                            ...
                            resolve({ data: canvas.toDataURL(format, quality), w: canvas.width, h: canvas.height });
                        };
                        img.onerror = () => resolve({ data: reader.result, w: 800, h: 600 });
            ...
            const drawLineChart = async (params, chartX, chartY, chartW, chartH, title, titleColor) => {
                ...
                // ── Single record: render a table instead of a chart ──
                if (pdfData.length === 1) {
                    const record = pdfData[0];
                    const dateLabel = new Date(record.analysis_date).toLocaleDateString('en-US', {
                        year: 'numeric', month: 'short', day: 'numeric'
                    });

                    const colWidths = [chartW * 0.45, chartW * 0.25, chartW * 0.30];
                    const headers = ['Parameter', 'Value', 'Date'];
                    const rowH = 7;
                    ...
                    // Rows for each param that has data
                    ...
                    params.forEach((param, pi) => {
                        ...
                        rowData.forEach((cell, ci) => {
                            ...
                            setTxtColor(ci === 1 ? '#E37239' : ci === 0 ? '#2d1f0f' : '#888888');
                            pdf.setFontSize(7.5);
                            pdf.setFont('helvetica', ci === 1 ? 'bold' : 'normal');
                            // Truncate if too long
                            const maxChars = Math.floor(colWidths[ci] / 2.2);
                            const display = String(cell).length > maxChars
                                ? String(cell).slice(0, maxChars - 1) + '…'
                                : String(cell);
                            pdf.text(display, cx, rowY);
                        });

                        rowY += rowH;

                        // If rows overflow the box, stop
                    ...
                    pdf.setFontSize(6.5);
                    pdf.setFont('helvetica', 'italic');
                    pdf.text('Only 1 record available — trend chart requires 2 or more data points', chartX + 4, chartY + chartH - 3);
                    return;
                }

                // ── Multiple records: draw line chart as before ──
                ...
                const visibleCount = params.filter(param =>
                    sorted.some(item => !isNaN(parseFloat(item[param.key])))
                ).length;
                const legendRows = Math.ceil((visibleCount || 1) / 6);
                ...
                if (allVals.length === 0) {
                    ...
                    setTxtColor('#999999');
                    pdf.setFont('helvetica', 'italic');
                    pdf.text('No data', chartX + chartW / 2 - 8, chartY + chartH / 2);
                    return;
                }
                ...
                sorted.forEach((item, i) => {
                    if (i % Math.ceil(sorted.length / 5) === 0 || i === sorted.length - 1) {
                        ...
                        const dateLabel = new Date(item.analysis_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' });
                        setTxtColor('#999999');
                        pdf.setFontSize(5.5);
                        pdf.text(dateLabel, px - 4, chartY + chartH - 2);
                    }
                });
                ...
                visibleParams.forEach((param, pi) => {
                    ...
                    setFill(lineColor);
                    pdf.roundedRect(lx, ly, 7, 2.5, 0.5, 0.5, 'F');
                    setTxtColor('#333333');
                    pdf.setFontSize(5.5);
                    pdf.setFont('helvetica', 'normal');
                    const truncated = param.label.length > 14 ? param.label.slice(0, 13) + '…' : param.label;
                    pdf.text(truncated, lx + 9, ly + 2);
                });
                ...
                params.forEach((param, pi) => {
                    ...
                    const points = sorted.map((item, i) => {
                        ...
                        return {
                            x: chartX + padL + i * xStep,
                            y: chartY + padT + plotH - ((v - minVal) / valRange) * plotH
                        };
                    }).filter(Boolean);
                    ...
                    points.forEach(pt => {
                        setFill(lineColor);
                        pdf.circle(pt.x, pt.y, 0.8, 'F');
                    });
                });
            };

            const drawSingleRecordTable = (params, tableX, tableY, tableW, title, titleColor) => {
                const record = pdfData[0];
                const dateLabel = new Date(record.analysis_date).toLocaleDateString('en-US', {
                    year: 'numeric', month: 'short', day: 'numeric'
                });

                // Filter only params that have data
                const validParams = params.filter(p => {
                    const val = record[p.key];
                    return val !== null && val !== undefined && val !== '';
                });

                if (validParams.length === 0) return tableY;

                const rowH = 7;
                const headerH = 9;
                const totalH = headerH + validParams.length * rowH + 10;
                ...
                pdf.setFont('helvetica', 'bold');
                setTxtColor(titleColor || '#E37239');
                pdf.text(title, tableX, tableY - 2);

                // Outer box
                filledRect(tableX, tableY, tableW, totalH, '#fff8ee', 2);
                setDraw('#dddddd');
                pdf.setLineWidth(0.2);
                pdf.rect(tableX, tableY, tableW, totalH);

                const colWidths = [tableW * 0.45, tableW * 0.25, tableW * 0.30];
                const headers = ['Parameter', 'Value', 'Date'];

                // Header row background
                filledRect(tableX, tableY, tableW, headerH, '#f5e4c0', 2);

                // Header text
                headers.forEach((h, i) => {
                    const cx = tableX + 4 + colWidths.slice(0, i).reduce((a, b) => a + b, 0);
                    setTxtColor('#4a3728');
                    pdf.setFontSize(8);
                    pdf.setFont('helvetica', 'bold');
                    pdf.text(h.toUpperCase(), cx, tableY + 6);
                });
                ...
                // Data rows
                validParams.forEach((param, pi) => {
                    const val = record[param.key];
                    const ry = tableY + headerH + pi * rowH;

                    // Alternating row bg
                    filledRect(tableX, ry, tableW, rowH, pi % 2 === 0 ? '#ffffff' : '#fff8ee', 0);

                    // Row divider
                    setDraw('#eeeeee');
                    pdf.setLineWidth(0.1);
                    pdf.line(tableX, ry + rowH, tableX + tableW, ry + rowH);
                    ...
                    rowData.forEach((cell, ci) => {
                        const cx = tableX + 4 + colWidths.slice(0, ci).reduce((a, b) => a + b, 0);
                        setTxtColor(ci === 1 ? '#E37239' : ci === 0 ? '#2d1f0f' : '#888888');
                        pdf.setFontSize(7.5);
                        pdf.setFont('helvetica', ci === 1 ? 'bold' : 'normal');
                        const maxChars = Math.floor(colWidths[ci] / 2.2);
                ...
                pdf.setFontSize(6.5);
                pdf.setFont('helvetica', 'italic');
                pdf.text('Single record — trend chart requires 2 or more data points', tableX + 4, tableY + totalH - 2);

                return tableY + totalH + 8;
            };
            ...
            const logoResult = await loadImageAsBase64(logoArms, true);
            if (logoResult) {
                pdf.addImage(logoResult.data, 'PNG', margin + 1, 5, 12, 12);
            }
            pdf.setFontSize(16);
            pdf.setFont('helvetica', 'bold');
            setTxtColor('#EAB56F');
            pdf.text('Asset Analysis Report', margin + 18, 11);
            pdf.setFontSize(7.5);
            pdf.setFont('helvetica', 'normal');
            setTxtColor('#aaaaaa');
            pdf.text(`ID: #${asset_analysis_id}  •  Generated: ${new Date().toLocaleString()}`, margin + 18, 17);

            // ── Criticality badge with label ──
            const critStyles = {
                'Good/Ok': { bg: '#10b981', text: '#ffffff' },
                'Verify/Abnormal': { bg: '#f59e0b', text: '#ffffff' },
                'Severe': { bg: '#ef4444', text: '#ffffff' },
            };
            const cs = critStyles[criticalityStatus] || { bg: '#64748b', text: '#ffffff' };

            // Label above
            pdf.setFontSize(6.5);
            pdf.setFont('helvetica', 'normal');
            setTxtColor('#aaaaaa');
            pdf.text('CRITICALITY ANALYSIS STATUS', W - margin, 6, { align: 'right' });

            // Value pill
            const critLabel = criticalityStatus || 'Not Set';
            pdf.setFontSize(8.5);
            pdf.setFont('helvetica', 'bold');
            const critLabelW = pdf.getTextWidth(critLabel) + 12;
            setFill(cs.bg);
            pdf.roundedRect(W - margin - critLabelW, 8, critLabelW, 11, 3, 3, 'F');
            setTxtColor(cs.text);
            pdf.text(critLabel, W - margin - critLabelW / 2, 15, { align: 'center' });
            ...
            const cards = [
                ...
                { label: 'Component', value: componentData.asset_component_name },
                { label: 'Category', value: assetData.asset_category },
                { label: 'Type', value: assetData.asset_type },
                { label: 'Analysis Date', value: data.analysis_date ? new Date(data.analysis_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : '—' },
            ];
            ...
            // ── Asset Info ──
            sectionHeader('Asset Information', '#254252');
            const infoItems = [
                { label: 'Location', value: assetData.asset_location },
                { label: 'Trivector', value: formatTrivector(assetData.trivector) },
                { label: 'Created By', value: data.created_by },
                { label: 'Criticality', value: criticalityStatus || 'Not Set' },
            ...
            // ── Running Hours ──
            checkPage(52);
            sectionHeader('Running Hours', '#254252');

            const gaugeData = [
                { label: 'Asset Running Hours', value: assetRunningHours, max: maxAssetRunningHours, color: '#3b82f6', trackColor: '#475569' },
                { label: 'Oil Running Hours', value: oilRunningHours, max: maxOilRunningHours, color: '#F59E0B', trackColor: '#475569' },
            ];

            const gaugeCardH = 68;
            const gaugeCardGap = 6;
            const gaugeCardW = (contentW - gaugeCardGap) / 2;

            gaugeData.forEach((g, i) => {
                const gx = margin + i * (gaugeCardW + gaugeCardGap);
                const pct = Math.min(100, Math.max(0, (g.value / g.max) * 100));
                const isExceeded = g.value > g.max;

                // Dark card background
                filledRect(gx, y, gaugeCardW, gaugeCardH, '#1e293b', 4);

                // Colored card border (drawn as a rect outline)
                setDraw(g.color);
                pdf.setLineWidth(1);
                pdf.roundedRect(gx, y, gaugeCardW, gaugeCardH, 4, 4);

                // ── Draw semicircle gauge ──
                const arcCX = gx + gaugeCardW / 2;
                const arcCY = y + 42;
                const arcR = 24;
                const arcStroke = 5;
                ...
                // Draw track
                setDraw('#475569');
                pdf.setLineWidth(arcStroke);
                for (let s = 0; s < steps; s++) {
                    const a1 = 180 + (s / steps) * 180;
                    const a2 = 180 + ((s + 1) / steps) * 180;
                    const x1 = arcCX + arcR * Math.cos(toRad(a1));
                    const y1 = arcCY + arcR * Math.sin(toRad(a1));
                    const x2 = arcCX + arcR * Math.cos(toRad(a2));
                    const y2 = arcCY + arcR * Math.sin(toRad(a2));
                    pdf.line(x1, y1, x2, y2);
                }

                // Draw colored arc for value
                const valueSteps = Math.round(steps * (pct / 100));
                if (valueSteps > 0) {
                    setDraw(g.color);
                    pdf.setLineWidth(arcStroke);
                    for (let s = 0; s < valueSteps; s++) {
                        const a1 = 180 + (s / steps) * 180;
                        const a2 = 180 + ((s + 1) / steps) * 180;
                        const x1 = arcCX + arcR * Math.cos(toRad(a1));
                        const y1 = arcCY + arcR * Math.sin(toRad(a1));
                ...
                pdf.setFontSize(18);
                pdf.setFont('helvetica', 'bold');
                pdf.text(`${Math.round(pct)}%`, arcCX, arcCY - 2, { align: 'center' });

                // Label row
                pdf.setFontSize(9);
                pdf.setFont('helvetica', 'bold');
                setTxtColor('#ffffff');
                pdf.text(g.label, arcCX, arcCY + 12, { align: 'center' });

                // Sub-label: value / max hours
                pdf.setFontSize(7);
                pdf.setFont('helvetica', 'normal');
                setTxtColor('#94a3b8');
                pdf.text(`${g.value.toLocaleString()} / ${g.max.toLocaleString()} ${g.max > 0 ? 'hours' : ''}`, arcCX, arcCY + 17, { align: 'center' });

                // Exceeds limit badge
                if (isExceeded) {
                    filledRect(arcCX - 14, arcCY + 21, 28, 5, '#ef4444', 2);
                    setTxtColor('#ffffff');
                    pdf.setFontSize(5.5);
                    pdf.setFont('helvetica', 'bold');
                    pdf.text('EXCEEDS LIMIT', arcCX, arcCY + 25, { align: 'center' });
                }
            });
            ...
            if (data.recommendations) {
                const recLines = pdf.splitTextToSize(data.recommendations, contentW - 6);
            ...
            // ── Actions Taken (Severe) ──
            if (data.criticality_analysis_status === 'Severe' && data.action_taken) {
                checkPage(20);
                sectionHeader('Actions Taken', '#562f70');
                const actions = data.action_taken.split(',').filter(a => a.trim());
                actions.forEach((action, i) => {
                    checkPage(10);
                    filledRect(margin, y, contentW, 8, i % 2 === 0 ? '#fcf5ff' : '#f6e8ff', 2);
                    setDraw('#dcc8e8');
                    pdf.setLineWidth(0.2);
                    pdf.roundedRect(margin, y, contentW, 8, 2, 2);
                    setTxtColor('#2d1f0f');
                    pdf.setFontSize(8.5);
                    pdf.setFont('helvetica', 'normal');
                    pdf.text(`• ${action.trim()}`, margin + 4, y + 5.5);
                    y += 10;
                });
                y += 4;
            }
            ...
            // ── Report Documentation ──
            if (data.results || data.actions || data.asset_before || data.asset_after) {
                checkPage(20);
                sectionHeader('Report Documentation', '#145a14');
                ...
                if (data.results) {
                    ...
                    pdf.setFont('helvetica', 'bold');
                    setTxtColor('#145a14');
                    pdf.text('RESULTS', margin, y + 3);
                    y += 5;
                    const rLines = pdf.splitTextToSize(data.results, contentW - 6);
                    const rH = rLines.length * 4.5 + 6;
                    filledRect(margin, y, contentW, rH, '#f0fff4', 2);
                    setDraw('#bbf7d0');
                    pdf.setLineWidth(0.3);
                    pdf.roundedRect(margin, y, contentW, rH, 2, 2);
                    pdf.setFontSize(8.5);
                    pdf.setFont('helvetica', 'normal');
                    setTxtColor('#1f3e21');
                    pdf.text(rLines, margin + 3, y + 5);
                    y += rH + 5;
                }
                ...
                if (data.actions) {
                    ...
                    pdf.setFont('helvetica', 'bold');
                    setTxtColor('#145a14');
                    pdf.text('ACTIONS', margin, y + 3);
                    y += 5;
                    const aLines = pdf.splitTextToSize(data.actions, contentW - 6);
                    const aH = aLines.length * 4.5 + 6;
                    filledRect(margin, y, contentW, aH, '#f0fff4', 2);
                    setDraw('#bbf7d0');
                    pdf.setLineWidth(0.3);
                    pdf.roundedRect(margin, y, contentW, aH, 2, 2);
                    pdf.setFontSize(8.5);
                    pdf.setFont('helvetica', 'normal');
                    setTxtColor('#1f3e21');
                    pdf.text(aLines, margin + 3, y + 5);
                    y += aH + 5;
                }

                if (data.asset_before || data.asset_after) {
                    const imgPairs = [
                        { key: 'asset_before', label: 'BEFORE', color: '#327eca', badgeBg: '#E6F1FB' },
                        { key: 'asset_after', label: 'AFTER', color: '#0092ac', badgeBg: '#E1F5EE' },
                    ].filter(p => data[p.key]);

                    const getImageUrl = (filename) => {
                        if (!filename) return null;
                        const clean = filename.trim().replace(/^documentation\//, '').split(/[/\\]/).pop();
                        return `${config.baseApi}/documentation/${encodeURIComponent(clean)}`;
                    };

                    const cardW = imgPairs.length === 2 ? (contentW - 6) / 2 : contentW;
                    const imgDisplayH = 75;
                    const headerH = 10;
                    const footerH = 8;
                    const cardH = headerH + imgDisplayH + footerH;

                    checkPage(cardH + 20);
                    if (y < margin) y = margin;

                    // Section title with icon line
                    filledRect(margin, y, contentW, 10, '#f0fff4', 2);
                    setDraw('#10b981');
                    pdf.setLineWidth(0.4);
                    pdf.roundedRect(margin, y, contentW, 10, 2, 2);
                    pdf.setLineWidth(3);
                    pdf.line(margin, y + 5, margin, y + 5); // accent dot
                    setTxtColor('#145a14');
                    pdf.setFontSize(9);
                    pdf.setFont('helvetica', 'bold');
                    pdf.text('ASSET CONDITION — BEFORE & AFTER', margin + 4, y + 7);
                    y += 14;
                    ...
                    for (let i = 0; i < imgPairs.length; i++) {
                        ...
                        filledRect(cx + 1.5, y + 1.5, cardW, cardH, '#e0e0e0', 3);

                        // Card background
                        filledRect(cx, y, cardW, cardH, '#ffffff', 3);

                        // Colored top accent bar
                        filledRect(cx, y, cardW, headerH, color, 3);
                        // Fix bottom corners of header to be square
                        filledRect(cx, y + headerH - 3, cardW, 3, color, 0);

                        // Badge label
                        setTxtColor('#ffffff');
                        pdf.setFontSize(8);
                        pdf.setFont('helvetica', 'bold');
                        pdf.text(label, cx + cardW / 2, y + 7, { align: 'center' });

                        // Image area background
                        filledRect(cx, y + headerH, cardW, imgDisplayH, '#f8f9fa', 0);

                        // Load and draw image
                        const imgResult = await loadImageAsBase64(getImageUrl(data[key]));
                        if (imgResult) {
                            const aspect = imgResult.w / imgResult.h;
                            let drawW = cardW - 6;
                            let drawH = drawW / aspect;
                            if (drawH > imgDisplayH - 4) {
                                drawH = imgDisplayH - 4;
                                drawW = drawH * aspect;
                            }
                            const imgX = cx + (cardW - drawW) / 2;
                            const imgY = y + headerH + (imgDisplayH - drawH) / 2;
                            pdf.addImage(imgResult.data, 'JPEG', imgX, imgY, drawW, drawH);
                        } else {
                            filledRect(cx, y + headerH, cardW, imgDisplayH, '#f5f0e8', 0);
                            pdf.setFontSize(8);
                            setTxtColor('#aaaaaa');
                            pdf.setFont('helvetica', 'italic');
                            pdf.text('Image unavailable', cx + cardW / 2, y + headerH + imgDisplayH / 2, { align: 'center' });
                        }

                        // Footer bar with filename
                        filledRect(cx, y + headerH + imgDisplayH, cardW, footerH, badgeBg, 0);
                        // Fix top corners of footer to be square
                        filledRect(cx, y + headerH + imgDisplayH, cardW, 2, badgeBg, 0);
                        // Round bottom corners
                        filledRect(cx, y + cardH - 3, cardW, 3, badgeBg, 3);

                        const rawName = data[key] ? data[key].split(/[/\\]/).pop() : '';
                        const maxChars = Math.floor(cardW / 2.2);
                        const displayName = rawName.length > maxChars ? rawName.slice(0, maxChars - 1) + '…' : rawName;
                        setTxtColor(color);
                        pdf.setFontSize(6.5);
                        pdf.setFont('helvetica', 'normal');
                        pdf.text(displayName, cx + cardW / 2, y + headerH + imgDisplayH + footerH - 2, { align: 'center' });

                        // Card border
                        setDraw(color);
                        pdf.setLineWidth(0.5);
                        pdf.roundedRect(cx, y, cardW, cardH, 3, 3);
                    }
            ...
            const allParams = [
                ...(rotating ? wearMetalsParams.rotating : wearMetalsParams.stationaryMobile),
                ...(rotating ? contaminantsParams.rotating : stationary ? contaminantsParams.stationary : contaminantsParams.mobile),
                ...chemistryParams.common,
                ...(rotating ? chemistryParams.rotating : [...chemistryParams.stationaryMobile, ...(mobile ? chemistryParams.mobile : [])]),
            ];

            const colW = [contentW * 0.42, contentW * 0.3, contentW * 0.28];
            const cols = ['Parameter', 'Current Value', 'Unit'];
            ...
            allParams.forEach((param, i) => {
                ...
                const rowData = [param.label, String(val), param.unit || '—'];
                rowData.forEach((cell, ci) => {
                    const cx = margin + colW.slice(0, ci).reduce((a, b) => a + b, 0);
                    setTxtColor(ci === 1 ? '#171C2D' : '#555555');
                    pdf.setFontSize(7.5);
                    pdf.setFont('helvetica', ci === 1 ? 'bold' : 'normal');
            ...
            // ── Overview page ──
            const wearParams = rotating ? wearMetalsParams.rotating : wearMetalsParams.stationaryMobile;
            const contamParams = rotating ? contaminantsParams.rotating : stationary ? contaminantsParams.stationary : contaminantsParams.mobile;
            const chemParams = [
                ...chemistryParams.common,
                ...(rotating ? chemistryParams.rotating : [...chemistryParams.stationaryMobile, ...(mobile ? chemistryParams.mobile : [])])
            ];

            // ── Individual charts helper ──
            const chartsPerPage = 3;
            const titleH = 10;
            const gapH = 6;
            const indH = Math.floor((H - 18 - margin - (titleH + gapH) * chartsPerPage) / chartsPerPage);
            const drawIndividualPages = async (params, headerColor, categoryTitle) => {
                for (let i = 0; i < params.length; i++) {
                    if (i % chartsPerPage === 0) {
                        newPage();
                        filledRect(0, 0, W, 14, headerColor, 0);
                        setTxtColor('#ffffff');
                        pdf.setFontSize(11);
                        pdf.setFont('helvetica', 'bold');
                        const pageNum = Math.floor(i / chartsPerPage) + 1;
                        const totalPages = Math.ceil(params.length / chartsPerPage);
                        pdf.text(`${categoryTitle} — Individual Trends (${pageNum}/${totalPages})`, margin, 10);
                        y = 18;
                    }
                    const slotIndex = i % chartsPerPage;
                    const slotTop = y + slotIndex * (titleH + indH + gapH);
                    const chartY = slotTop + titleH;
                    await drawLineChart(
                        [params[i]], margin, chartY, contentW, indH,
                        `${params[i].label}${params[i].unit ? '  (' + params[i].unit + ')' : ''}`,
                        headerColor
                    );
                }
            };
            ...
            if (pdfData.length <= 1) {
                ...
                pdf.setFont('helvetica', 'normal');
                setTxtColor('#aaaaaa');
                pdf.text('Trend charts require 2 or more records. Showing current values table instead.', margin, 18);
                y = 28;

                const categories = [
                    { params: wearParams, title: 'Wear Metals', color: '#3F1D7D', bgColor: '#f5f0fe' },
                    { params: contamParams, title: 'Contaminants', color: '#228B22', bgColor: '#f0fdf4' },
                    { params: chemParams, title: 'Chemistry & Viscosity', color: '#C14E26', bgColor: '#fff7f0' },
                ];

                for (const cat of categories) {
                    const record = pdfData[0];
                    const validParams = cat.params.filter(p => {
                        const v = record[p.key];
                        return v !== null && v !== undefined && v !== '';
                    });
                    if (validParams.length === 0) continue;

                    const colWidths = [contentW * 0.44, contentW * 0.28, contentW * 0.28];
                    const rowH = 7;
                    const headerBarH = 9;
                    const tableH = headerBarH + validParams.length * rowH + 6;
                    ...
                    pdf.roundedRect(margin, y, contentW, headerBarH, 2, 2, 'F');
                    setTxtColor('#ffffff');
                    pdf.setFontSize(9);
                    pdf.setFont('helvetica', 'bold');
                    pdf.text(cat.title.toUpperCase(), margin + 4, y + 6.5);
                    y += headerBarH + 2;

                    // ── Column header row ──
                    const colHeaders = ['Parameter', 'Value', 'Unit'];
                    const dateLabel = new Date(record.analysis_date).toLocaleDateString('en-US', {
                        year: 'numeric', month: 'short', day: 'numeric'
                    });

                    filledRect(margin, y, contentW, rowH, '#f0eaff', 1);
                    setDraw('#cccccc');
                    pdf.setLineWidth(0.2);
                    pdf.line(margin, y + rowH, margin + contentW, y + rowH);
                    colHeaders.forEach((h, ci) => {
                        const cx = margin + colWidths.slice(0, ci).reduce((a, b) => a + b, 0) + 3;
                        setTxtColor('#555555');
                        pdf.setFontSize(7);
                        pdf.setFont('helvetica', 'bold');
                        pdf.text(h.toUpperCase(), cx, y + 5);
                    });
                    y += rowH;
                    ...
                    validParams.forEach((param, pi) => {
                        ...
                        const bgHex = pi % 2 === 0 ? '#ffffff' : cat.bgColor;
                        ...
                        let sepX = margin + colWidths[0];
                        pdf.line(sepX, ry, sepX, ry + rowH);
                        sepX += colWidths[1];
                        pdf.line(sepX, ry, sepX, ry + rowH);
                        ...
                        rowData.forEach((cell, ci) => {
                            ...
                            if (ci === 0) {
                                ...
                                const [vr, vg, vb] = hexToRgb(cat.color);
                    ...
                    setDraw(cat.color);
                    pdf.setLineWidth(0.4);
                    pdf.roundedRect(margin, y - (validParams.length * rowH) - rowH, contentW, validParams.length * rowH + rowH, 1, 1);

                    // ── Analysis date footer ──
                    setTxtColor('#aaaaaa');
                    pdf.setFontSize(6.5);
                    pdf.setFont('helvetica', 'italic');
                    pdf.text(`Analysis date: ${dateLabel}`, margin, y + 4);
                    y += 12;
                }
            } else {
                newPage();
                ...
                pdf.setFontSize(12);
                pdf.setFont('helvetica', 'bold');
                pdf.text('Historical Trends — Overview', margin, 10);

                // Each chart has a title label above it (8mm) + the chart body + a gap between charts (4mm)
                const titleH = 8;   // space reserved above each chart for the title text
                const gapH = 4;     // gap between chart slots
                const slots = 3;
                const availableH = H - 14 - margin - (titleH + gapH) * slots;
                const overviewChartH = Math.floor(availableH / slots);

                // Position each chart so title + chart body fits evenly
                const slot0Y = 14 + margin + titleH;
                const slot1Y = slot0Y + overviewChartH + gapH + titleH;
                const slot2Y = slot1Y + overviewChartH + gapH + titleH;

                await drawLineChart(wearParams, margin, slot0Y, contentW, overviewChartH, 'Wear Metals', '#3F1D7D');
                await drawLineChart(contamParams, margin, slot1Y, contentW, overviewChartH, 'Contaminants', '#228B22');
                await drawLineChart(chemParams, margin, slot2Y, contentW, overviewChartH, 'Chemistry & Viscosity', '#C14E26');
                await drawIndividualPages(wearParams, '#3F1D7D', 'Wear Metals');
                await drawIndividualPages(contamParams, '#228B22', 'Contaminants');
                await drawIndividualPages(chemParams, '#C14E26', 'Chemistry & Viscosity');
            }

            const fileName = `Asset_Analysis_Report_${(assetData.asset_name || 'Report').replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`;
            pdf.save(fileName);
    ...
    }, [data, assetData, componentData, criticalityStatus, resamplingSchedule, assetRunningHours,
        oilRunningHours, maxAssetRunningHours, maxOilRunningHours, filteredMatchData,
        rotating, stationary, mobile, asset_analysis_id, showAlertMessage, formatTrivector, matchData]);

    return (
        <div id="asset-analysis-report-root" style={{ background: 'radial-gradient(circle at 10% 30%, #254252 0%, #171C2D 100%)', minHeight: '100vh', padding: 'clamp(20px, 5vw, 40px)', position: 'relative', overflow: 'hidden', paddingTop: 'clamp(30px, 6vw, 50px)' }}>
            <Loading show={isLoading} />
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap', marginLeft: 'auto' }}>
                                ...
                                {(data.results || data.actions || data.asset_before || data.asset_after) && (
                                    <button
                                        ...
                                        onMouseEnter={(e) => {
                                            e.currentTarget.style.background = 'linear-gradient(135deg, #EAB56F 0%, #F9982F 100%)';
                                            e.currentTarget.style.color = 'white';
                                            e.currentTarget.style.transform = 'translateY(-2px)';
                                            e.currentTarget.style.boxShadow = '0 8px 25px rgba(234,181,111,0.4)';
                                        }}
                                        onMouseLeave={(e) => {
                                            e.currentTarget.style.background = 'linear-gradient(135deg, #EAB56F, #F9982F, #E37239)',
                                ...
                                {data.level1 === '1' && data.level2 === '1' && data.level3 === '1' && data.appropriate_action === 'yes' && (
                                    ...
                                    >
                                        {/* <FeatherIcon icon="bell" size={18} /> */}
                                        <span>Level 3 Action Notice</span>
                                        <div style={{
                                            width: '8px',
                                            height: '8px',
                                            background: '#fbbf24',
...
const contaminantsParams = {
    rotating: [
        ...
        { label: "Potassium", key: "potassium", unit: "ppm" },
        { label: "Lithium", key: "lithium", unit: "ppm" },
        { label: "ISO 4406 (>4um)", key: "iso_4406_code_gt4um" },
        { label: "ISO 4406 (>6um)", key: "iso_4406_code_gt6um" },
        { label: "ISO 4406 (>14um)", key: "iso_4406_code_gt14um" },
        { label: "Cnts >4", key: "cnts_gt4", unit: "particles/ml" },
        { label: "Cnts >6", key: "cnts_gt6", unit: "particles/ml" },
        { label: "Cnts >14", key: "cnts_gt14", unit: "particles/ml" },
        { label: "Particles 5-15um", key: "particles_5_15um", unit: "particles/100" },
