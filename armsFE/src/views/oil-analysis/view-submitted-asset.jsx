...
//         if (!data.appropriate_action || !data.action_notes) return null;
...
//                             <span>Action Not Taken Appropriately</span>
//                         </Modal.Title>
//                     </Modal.Header>
...
//                                 <FeatherIcon icon="alert-triangle" size={20} color="#dc2626" />
//                                 <span style={{ fontWeight: '700', color: '#991b1b', fontSize: '16px' }}>
//                                     Appropriate Action Status: {data.appropriate_action === 'yes' ? 'Taken' : 'Not Taken'}
//                                 </span>
//                             </div>
//                             <p style={{ margin: 0, color: '#7f1d1d', fontSize: '13px', marginLeft: '32px' }}>
//                                 {data.appropriate_action === 'no'
//                                     ? 'The recommended actions were not taken appropriately as per Level 3 review.'
//                                     : 'The recommended actions were taken appropriately.'}
//                             </p>
//                         </div>
...
//                                 <FeatherIcon icon="edit-3" size={18} color="#f59e0b" />
...
//                                 e.currentTarget.style.boxShadow = '0 4px 12px rgba(233, 150, 40, 0.4)';
//                             }}
//                             onMouseLeave={(e) => {
//                                 e.currentTarget.style.transform = 'translateY(0)';
...
//             {empInfo.emp_position !== 'l1' && canAccessL2Actions && (
//                 <>
...
// // Parameter definitions (these remain the same as in your original code)
